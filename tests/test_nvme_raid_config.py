...
def test_repository_test_items_file_is_valid():
    ...
    assert params["lawdisk"]["FIO_CONFIG"] == "Input_Config_lawdisk_4k.csv"
    assert params["mix"]["FIO_CONFIG"] == "Input_Config_mix_4k.csv"
    ...
    assert params["basic_io"]["FIO_CONFIG"] == "Input_Config_basic_io_4k.csv"
    assert params["random_io"]["FIO_CONFIG"] == "Input_Config_random_io_4k.csv"
