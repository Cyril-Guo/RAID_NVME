...
def test_item_name_from_filename_supports_ci_and_plain_patterns():
    assert item_name_from_filename("test_ci_01_lawdisk_4k.py") == "test_ci_01_lawdisk_4k"
    assert item_name_from_filename("test_ci_05_mix_4k.py") == "test_ci_05_mix_4k"
...
def test_discover_test_items_finds_repository_ci_cases():
    ...
    assert catalog["test_ci_01_lawdisk_4k"] == "test_items/test_ci_01_lawdisk_4k.py"
    assert catalog["test_ci_02_lawdisk_512"] == "test_items/test_ci_02_lawdisk_512.py"
    assert catalog["test_ci_03_filesystem_4k"] == "test_items/test_ci_03_filesystem_4k.py"
    assert catalog["test_ci_04_filesystem_512"] == "test_items/test_ci_04_filesystem_512.py"
    assert catalog["test_ci_05_mix_4k"] == "test_items/test_ci_05_mix_4k.py"
    assert catalog["test_ci_06_mix_512"] == "test_items/test_ci_06_mix_512.py"
    assert catalog["test_ci_07_random_io_4k"] == "test_items/test_ci_07_random_io_4k.py"
    assert catalog["test_ci_08_random_io_512"] == "test_items/test_ci_08_random_io_512.py"
    assert set(catalog) == {
        "test_ci_00_env_prepare",
        "test_ci_01_lawdisk_4k",
        "test_ci_02_lawdisk_512",
        "test_ci_03_filesystem_4k",
        "test_ci_04_filesystem_512",
        "test_ci_05_mix_4k",
        "test_ci_06_mix_512",
        "test_ci_07_random_io_4k",
        "test_ci_08_random_io_512",
    }
...
def test_repository_test_items_file_is_valid():
    ...
    assert params["test_ci_01_lawdisk_4k"]["IGNORE_ERROR"] == "yes"
    assert params["test_ci_01_lawdisk_4k"]["FIO_CONFIG"] == "Input_Config_lawdisk_4k.csv"
    assert params["test_ci_02_lawdisk_512"]["FIO_CONFIG"] == "Input_Config_lawdisk_512.csv"
    assert params["test_ci_05_mix_4k"]["FIO_CONFIG"] == "Input_Config_mix_4k.csv"
    assert params["test_ci_05_mix_4k"]["MIX_FAIL_ON_ANY"].strip().lower() in ("yes", "no")
    assert params["test_ci_05_mix_4k"]["IO_BS_ALIGN"] == "4k"
    assert params["test_ci_06_mix_512"]["IO_BS_ALIGN"] == "512"
    assert params["test_ci_03_filesystem_4k"]["FIO_RUNTIME"] == "43200"
    assert "FIO_RUNTIME" in nvme_raid_test.ALLOWED_PARAM_KEYS
    assert params["test_ci_07_random_io_4k"]["FIO_CONFIG"] == "Input_Config_random_io_4k.csv"
    assert "FIO_CYCLES" not in params["test_ci_01_lawdisk_4k"]
...
""",
    ...
    catalog = {
        "test_ci_01_lawdisk_4k": "test_items/test_ci_01_lawdisk_4k.py",
        "test_ci_02_lawdisk_512": "test_items/test_ci_02_lawdisk_512.py",
        "test_ci_03_filesystem_4k": "test_items/test_ci_03_filesystem_4k.py",
        "test_ci_05_mix_4k": "test_items/test_ci_05_mix_4k.py",
    }
    ...
    assert selected == ["test_ci_01_lawdisk_4k"]
    assert [(name, orders, enabled) for name, orders, enabled in entries] == [
        ("test_ci_02_lawdisk_512", [2], False),
        ("test_ci_01_lawdisk_4k", [3], True),
        ("test_ci_05_mix_4k", [5], False),
        ("test_ci_03_filesystem_4k", [6], False),
    ]
    assert "test_ci_01_lawdisk_4k 3\n" in text
    assert "# test_ci_02_lawdisk_512 2\n" in text
    assert "# test_ci_05_mix_4k 5\n" in text
    assert "# test_ci_03_filesystem_4k 6\n" in text
...
# === BEGIN SELECTION（自动同步；完整用例名 + 执行序号，# 表示不跑）===
test_ci_05_mix_4k 1
# test_ci_03_filesystem_4k 2
test_ci_01_lawdisk_4k 3
# test_ci_02_lawdisk_512 4
# === END SELECTION ===
...
""",
    ...
    assert selected == ["test_ci_05_mix_4k", "test_ci_01_lawdisk_4k"]
...
""",
    ...
    assert selected == ["test_ci_02_lawdisk_512", "test_ci_05_mix_4k"]
    assert params["test_ci_02_lawdisk_512"] == {"FIO_CYCLES": "3", "IGNORE_ERROR": "no"}
    assert params["test_ci_05_mix_4k"] == {"FIO_DISKS": "sdb,sdc", "STRESS_MONITOR": "yes"}
    assert "FIO_CYCLES" not in params["test_ci_05_mix_4k"]
...
""",
    ...
    assert selected == ["test_ci_02_lawdisk_512", "test_ci_01_lawdisk_4k", "test_ci_05_mix_4k"]



def test_parse_selection_entry_supports_multiple_orders():
    assert nvme_raid_test.parse_selection_entry("test_ci_05_mix_4k 8 10") == (
        "test_ci_05_mix_4k",
        [8, 10],
        True,
    )
    ...
    assert nvme_raid_test.parse_selection_entry("test_ci_05_mix_4k 1") == (
        "test_ci_05_mix_4k",
        [1],
        True,
    )
    # order-first still accepted
    assert nvme_raid_test.parse_selection_entry("8 10 test_ci_05_mix_4k") == (
        "test_ci_05_mix_4k",
        [8, 10],
        True,
    )
...
def test_read_enabled_selection_repeats_item_for_multiple_orders(tmp_path):
    ...
    config.write_text(
        """
# === BEGIN SELECTION（自动同步；完整用例名 + 执行序号，# 表示不跑）===
test_ci_05_mix_4k 8 10
test_ci_05_mix_4k 1
test_ci_07_random_io_4k 9
# === END SELECTION ===
...
""",
    ...
    catalog = {
        "test_ci_05_mix_4k": "test_items/test_ci_05_mix_4k.py",
        "test_ci_07_random_io_4k": "test_items/test_ci_07_random_io_4k.py",
    }
    ...
    assert selected == ["test_ci_05_mix_4k", "test_ci_05_mix_4k", "test_ci_07_random_io_4k", "test_ci_05_mix_4k"]
    assert [entry["item"] for entry in plan] == selected
    assert [entry["run_key"] for entry in plan] == [
        "test_ci_05_mix_4k__1",
        "test_ci_05_mix_4k__8",
        "test_ci_07_random_io_4k__9",
        "test_ci_05_mix_4k__10",
    ]
...
""",
    ...
    catalog = {"test_ci_01_lawdisk_4k": "test_items/test_ci_01_lawdisk_4k.py"}

    plan = nvme_raid_test.build_run_plan(str(config), test_items=catalog)

    assert plan == [{"item": "test_ci_01_lawdisk_4k", "order": 3, "run_key": "test_ci_01_lawdisk_4k__3"}]
...
def test_validate_powercycle_plan_rejects_mixed_or_multiple_powercycle_runs():
    ...
    with pytest.raises(ValueError, match="must run alone"):
        nvme_raid_test.validate_powercycle_plan(
            [
                {"item": "test_ci_01_reboot", "order": 1, "run_key": "test_ci_01_reboot__1"},
                {"item": "test_ci_05_mix_4k", "order": 2, "run_key": "test_ci_05_mix_4k__2"},
            ]
        )
...
def test_run_single_item_omits_allure_args_without_plugin(monkeypatch, tmp_path):
    ...
    assert nvme_raid_test.run_single_item(
        "test_ci_01_lawdisk_4k", {}, clean_allure=True, work_dir=str(tmp_path)
    ) == 0

    args = captured["args"]
    assert "--clean-alluredir" not in args
    assert not any(arg.startswith("--alluredir=") for arg in args)
    assert "--junitxml=report_test_ci_01_lawdisk_4k.xml" in args
...
def test_run_single_item_does_not_clear_csd(monkeypatch, tmp_path):
    ...
    for item in ("test_ci_05_mix_4k", "test_ci_07_random_io_4k", "test_ci_00_env_prepare"):
        clear_calls.clear()
        assert (
...
def test_run_single_item_uses_run_key_for_junit_and_env(monkeypatch, tmp_path):
    ...
    assert captured["item"] == "test_ci_01_lawdisk_4k"
...
def test_prepare_case_workdir_isolates_io_stress(tmp_path):
    ...
    case_dir = Path(nvme_raid_test.prepare_case_workdir(str(repo), "test_ci_05_mix_4k"))

    assert case_dir == repo / "cases" / "test_ci_05_mix_4k"
...
def test_main_stops_after_first_failed_item(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        ...
        lambda path, test_items=None: [
            {"item": "test_ci_01_lawdisk_4k", "order": 3, "run_key": "test_ci_01_lawdisk_4k"},
            {"item": "test_ci_05_mix_4k", "order": 5, "run_key": "test_ci_05_mix_4k"},
        ],
    )
    monkeypatch.setattr(
        nvme_raid_test,
        "parse_items_file",
        lambda path: (["test_ci_01_lawdisk_4k", "test_ci_05_mix_4k"], {"test_ci_01_lawdisk_4k": {}, "test_ci_05_mix_4k": {}}),
    )
    monkeypatch.setattr(
        nvme_raid_test,
        "discover_test_items",
    ...
    monkeypatch.setattr(
        nvme_raid_test,
        "run_single_item",
        lambda item, params, clean_allure, test_items=None, work_dir=None, **kwargs: executed.append(item) or (1 if item == "test_ci_01_lawdisk_4k" else 0),
    )
    monkeypatch.setattr(
        nvme_raid_test,
        "merge_junit_reports",
    ...
    assert executed == ["test_ci_01_lawdisk_4k"]
    assert merged_calls == [["test_ci_01_lawdisk_4k"]]
...
def test_main_uses_whitelist_order_not_discovery_order(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        ...
        "build_run_plan",
        lambda path, test_items=None: [
            {"item": "test_ci_05_mix_4k", "order": 1, "run_key": "test_ci_05_mix_4k"},
            {"item": "test_ci_01_lawdisk_4k", "order": 3, "run_key": "test_ci_01_lawdisk_4k"},
        ],
    )
    monkeypatch.setattr(
        nvme_raid_test,
        "parse_items_file",
        lambda path: (["test_ci_05_mix_4k", "test_ci_01_lawdisk_4k"], {"test_ci_05_mix_4k": {}, "test_ci_01_lawdisk_4k": {}}),
    )
    monkeypatch.setattr(
        nvme_raid_test,
        "discover_test_items",
    ...
    assert executed == ["test_ci_05_mix_4k", "test_ci_01_lawdisk_4k"]
