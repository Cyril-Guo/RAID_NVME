...
from vd_io import report_metrics
...
<testsuites tests="0" failures="0" errors="0" skipped="0">
  <testsuite name="pytest">
    ...
    <testcase classname="test_items.test_vd_io_04_mix" name="test_mix_stress">
      <failure message="fio failed">trace</failure>
    </testcase>
    <testcase classname="test_items.test_vd_io_05_reboot" name="test_reboot_powercycle">
...
""",
    ...
    # Physical_Restore must not inflate Feishu Total / case fail counters.
...
def test_report_metrics_merges_native_allure_failure_missing_from_junit(tmp_path, monkeypatch):
  ...
  <testcase classname="test_items.test_vd_io_03_mix_4k" name="test_mix_stress">
    <properties><property name="run_key" value="test_vd_io_03_mix_4k__1" /></properties>
  </testcase>
</testsuite>
""",
        encoding="utf-8",
        ...
        json.dumps(
            {
                ...
                "fullName": "physical:192.168.22.134:test_items.test_vd_io_03_mix_4k#test_mix_stress",
                "status": "passed",
                "labels": [
                    {"name": "host", "value": "192.168.22.134"},
                    {"name": "run_key", "value": "test_vd_io_03_mix_4k__1"},
                ],
            }
        ),
        encoding="utf-8",
        ...
        json.dumps(
            {
                ...
                "labels": [
                    {"name": "host", "value": "192.168.22.134"},
                    {"name": "run_key", "value": "test_vd_io_03_mix_4k__2"},
                ],
            }
        ),
        encoding="utf-8",
