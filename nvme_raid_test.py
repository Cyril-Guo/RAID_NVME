...
ITEM_PARAMS = {
    ...
    "multi_raid_io": ["IGNORE_ERROR", "FIO_DISKS", "STRESS_MONITOR", "MONITOR_RUNTIME", "LOGICAL_BLOCK_SIZE", "FIO_CONFIG"],
    "multi_raid_degraded_io": ["IGNORE_ERROR", "FIO_DISKS", "STRESS_MONITOR", "MONITOR_RUNTIME", "LOGICAL_BLOCK_SIZE", "FIO_CONFIG"],
}
...
def run_single_item(item, params, clean_allure, work_dir=None):
    ...
    # Every case: rmmod -> insmod -> dpraid flash-clear --with-cache --force -> rmmod -> insmod.
    previous = os.getcwd()
    try:
        os.chdir(work_dir)
