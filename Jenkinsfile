    ...
    post {
        always {
            script {
                ...
                archiveArtifacts artifacts: 'jenkins_console.log, test_execution_*.log, environment_prepare_*.log, allure-results/monitor_log_*.tar.gz, failure_bundle_*.tar.gz', allowEmptyArchive: true
