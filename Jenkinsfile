        ...
        always {
            script {
                ...
                withEnv([
                    ...
                    "ALLOW_EMPTY_WITH_ATTEMPT=1",
                    "KERNEL_DRIVER_BRANCH=main",
                    "KERNEL_DRIVER_REF=",
                    "KERNEL_DRIVER_COMMIT=unknown",
                    "KERNEL_DRIVER_MR_IID=",
                    "KERNEL_DRIVER_MR_TITLE=",
                    "KERNEL_DRIVER_MR_UPDATED_AT=",
                    "KERNEL_DRIVER_MR_URL=",
                    "RAID_CLI_BRANCH=hostraid_cli",
                    "RAID_CLI_COMMIT=unknown",
